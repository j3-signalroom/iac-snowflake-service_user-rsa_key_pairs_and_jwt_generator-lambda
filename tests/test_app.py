...
def load_configurations():
    ...
    account_config[ACCOUNT_CONFIG["snowflake_service_user"]] = os.getenv("SNOWFLAKE_USER")
    ...
    logger.info("Snowflake User: %s", account_config[ACCOUNT_CONFIG["snowflake_service_user"]])
...
def test_generate_key_pairs():
    ...
    key_pairs = GenerateKeyPairs(account_config[ACCOUNT_CONFIG["snowflake_account_identifier"]], account_config[ACCOUNT_CONFIG["snowflake_service_user"]], account_config[ACCOUNT_CONFIG["secrets_path"]])
